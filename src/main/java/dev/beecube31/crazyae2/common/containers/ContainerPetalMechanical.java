...
public class ContainerPetalMechanical extends ContainerMechanicalBotaniaTileBase {
    public ContainerPetalMechanical(InventoryPlayer ip, TileMechanicalPetal te) {
        super(ip, te);
    }

...
public class ContainerManapoolMechanical extends ContainerMechanicalBotaniaTileBase {
    public ContainerManapoolMechanical(InventoryPlayer ip, TileMechanicalManapool te) {
        super(ip, te);
    }

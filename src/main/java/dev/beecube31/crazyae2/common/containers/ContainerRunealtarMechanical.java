...
public class ContainerRunealtarMechanical extends ContainerMechanicalBotaniaTileBase {
    public ContainerRunealtarMechanical(InventoryPlayer ip, TileMechanicalRunealtar te) {
        super(ip, te);
    }

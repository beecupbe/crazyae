...
import dev.beecube31.crazyae2.client.gui.implementations.GuiEnergyTerminal;
...
public class ContainerEnergyTerminal extends CrazyAEBaseContainer implements IConfigManagerHost, IConfigurableObject, IMEMonitorHandlerReceiver<IAEItemStack> {
    private final IConfigManager clientCM;
    private final IMEMonitor<IAEItemStack> monitor;
    private final IItemList<IAEItemStack> items = Api.INSTANCE.storage().getStorageChannel(IEnergyStorageChannel.class).createList();
    @GuiSync(99)
    ...
    public ContainerEnergyTerminal(final InventoryPlayer ip, final ITerminalHost monitorable) {
        ...
        if (Platform.isServer()) {
            ...
            this.monitor = monitorable.getInventory(AEApi.instance().storage().getStorageChannel(IEnergyStorageChannel.class));
        ...
        this.bindPlayerInventory(ip, 0, 108);
    }
    ...
    public void postUpdate(final List<IAEItemStack> list) {
        ...
        ((GuiEnergyTerminal) this.gui).postUpdate(list);
    }
    ...
    public void detectAndSendChanges() {
        if (Platform.isServer()) {
            if (this.monitor != this.terminal.getInventory(AEApi.instance().storage().getStorageChannel(IEnergyStorageChannel.class))) {
                this.setValidContainer(false);
            }

...
public class CrazyAEStackUpgradeInv extends CrazyAEUpgradeInventory {
    private final ItemStack stack;

    public CrazyAEStackUpgradeInv(final ItemStack stack, final IAEAppEngInventory inventory, final int s) {
        super(inventory, s);
        this.stack = stack;
    }

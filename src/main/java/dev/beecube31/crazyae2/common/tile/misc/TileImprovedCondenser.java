...
public class TileImprovedCondenser extends AEBaseInvTile implements IConfigManagerHost, IConfigurableObject {
    ...
    private final AppEngInternalInventory outputSlot = new AppEngInternalInventory(this, 4);
    ...
    private class FluidHandler implements IFluidHandler {
        ...
        public int fill(FluidStack resource, boolean doFill) {
            if (doFill) {
                ...
                TileImprovedCondenser.this.addPower((resource == null ? 0.0 : (double) resource.amount) / chan.transferFactor());
            }
    ...
    private class MEHandler implements IStorageMonitorableAccessor, IStorageMonitorable {
        private final CondenserItemInventory itemInventory = new CondenserItemInventory(TileImprovedCondenser.this);
        ...
        public <T extends IAEStack<T>> IMEMonitor<T> getInventory(IStorageChannel<T> channel) {
            if (channel == AEApi.instance().storage().getStorageChannel(IItemStorageChannel.class)) {
                ...
                return new CondenserVoidInventory<>(TileImprovedCondenser.this, channel);
            }
        }
    }
}

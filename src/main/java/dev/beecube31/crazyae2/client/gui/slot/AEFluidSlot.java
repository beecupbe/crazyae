...
public class AEFluidSlot extends CustomSlot implements IJEITargetSlot {
    private final IAEFluidTank fluids;
    private final int slot;

    public AEFluidSlot(final IAEFluidTank fluids, final int slot, final int id, final int x, final int y) {
        super(id, x, y);
        this.fluids = fluids;
        this.slot = slot;
    }

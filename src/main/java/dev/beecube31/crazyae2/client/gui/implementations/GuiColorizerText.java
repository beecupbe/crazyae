...
import dev.beecube31.crazyae2.client.gui.widgets.*;
...
public class GuiColorizerText extends CrazyAEBaseGui implements IGuiElementsCallbackHandler {
    ...
    private final ContainerColorizerText container;

    protected final ColorizerType type;

    public GuiColorizerText(final InventoryPlayer inventoryPlayer, final ColorizerObj te) {
        super(new ContainerColorizerText(inventoryPlayer, te));
        this.container = (ContainerColorizerText) this.inventorySlots;
        this.ySize = 128;
        this.xSize += 26;
        this.type = ColorizerType.TEXT;
    }
    ...
    private void restoreDefaults() {
        this.sliderR.setScroll(0);
        this.sliderG.setScroll(0);
        this.sliderB.setScroll(0);
    ...
    public void initGui() {
        ...
        (this.sliderR = new Slider(
                ...
                this.getGuiHue(),
                this)
        ).setScroll(CrazyAEClientConfig.getColorizerTextColorRed());
        (this.sliderG = new Slider(
                ...
                this.getGuiHue(),
                this)
        ).setScroll(CrazyAEClientConfig.getColorizerTextColorGreen());
        (this.sliderB = new Slider(
                ...
                this.getGuiHue(),
                this)
        ).setScroll(CrazyAEClientConfig.getColorizerTextColorBlue());
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.drawString(this.getGuiDisplayName(CrazyAEGuiText.GUI_COLORIZER_TEXT.getLocal()), 8, 6);
    }
    ...
    public void onInteractionUpdate() {
        CrazyAEClientState.applyColorizerText(

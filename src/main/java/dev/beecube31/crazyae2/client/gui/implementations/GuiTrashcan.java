...
public class GuiTrashcan extends GuiCrazyAEUpgradeable {


    public GuiTrashcan(final InventoryPlayer inventoryPlayer, final TileTrashcanBase te) {
        super(new ContainerTrashcan(inventoryPlayer, te));
        this.ySize = 256;

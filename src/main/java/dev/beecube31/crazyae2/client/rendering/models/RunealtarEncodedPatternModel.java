...
public class RunealtarEncodedPatternModel implements IModel {

    private static final ResourceLocation BASE_MODEL = new ResourceLocation(Tags.MODID, "item/runealtar_encoded_pattern");
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new RunealtarEncodedPatternBakedModel(baseModel, transforms);
    }

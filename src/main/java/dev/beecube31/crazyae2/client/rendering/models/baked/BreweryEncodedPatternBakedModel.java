...
import dev.beecube31.crazyae2.common.items.patterns.BreweryEncodedPattern;
...
public class BreweryEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        BreweryEncodedPattern iep = (BreweryEncodedPattern) stack.getItem();
    ...
    public BreweryEncodedPatternBakedModel(IBakedModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms) {
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(BreweryEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            ...
            return BreweryEncodedPatternBakedModel.this.baseModel.getOverrides().handleItemState(originalModel, stack, world, entity);
        }
    }
}

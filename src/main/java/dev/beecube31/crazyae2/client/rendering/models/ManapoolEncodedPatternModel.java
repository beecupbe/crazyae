...
public class ManapoolEncodedPatternModel implements IModel {

    private static final ResourceLocation BASE_MODEL = new ResourceLocation(Tags.MODID, "item/manapool_encoded_pattern");
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new ManapoolEncodedPatternBakedModel(baseModel, transforms);
    }

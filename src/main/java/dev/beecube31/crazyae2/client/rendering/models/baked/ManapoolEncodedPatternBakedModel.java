...
public class ManapoolEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        ManapoolEncodedPattern iep = (ManapoolEncodedPattern) stack.getItem();
    ...
    public ManapoolEncodedPatternBakedModel(IBakedModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms) {
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(ManapoolEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            ...
            return ManapoolEncodedPatternBakedModel.this.baseModel.getOverrides().handleItemState(originalModel, stack, world, entity);
        }
    }
}

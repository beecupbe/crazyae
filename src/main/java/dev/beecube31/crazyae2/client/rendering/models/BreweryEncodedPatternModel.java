...
import dev.beecube31.crazyae2.client.rendering.models.baked.BreweryEncodedPatternBakedModel;
...
public class BreweryEncodedPatternModel implements IModel {

    private static final ResourceLocation BASE_MODEL = new ResourceLocation(Tags.MODID, "item/brewery_encoded_pattern");
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new BreweryEncodedPatternBakedModel(baseModel, transforms);
    }

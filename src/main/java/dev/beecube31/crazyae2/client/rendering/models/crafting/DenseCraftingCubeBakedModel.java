...
abstract class DenseCraftingCubeBakedModel implements IBakedModel {
	...
	DenseCraftingCubeBakedModel(VertexFormat format, TextureAtlasSprite ringCorner, TextureAtlasSprite ringHor, TextureAtlasSprite ringVer) {
		this.format = format;
	...
	protected abstract void addInnerCube(IBlockState var2, CubeBuilder var3, float var4, float var5, float var6, float var7, float var8, float var9);

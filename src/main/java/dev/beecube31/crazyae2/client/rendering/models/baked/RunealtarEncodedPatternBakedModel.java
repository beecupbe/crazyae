...
public class RunealtarEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        RunealtarEncodedPattern iep = (RunealtarEncodedPattern) stack.getItem();
    ...
    public RunealtarEncodedPatternBakedModel(IBakedModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms) {
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(RunealtarEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            ...
            return RunealtarEncodedPatternBakedModel.this.baseModel.getOverrides().handleItemState(originalModel, stack, world, entity);
        }
    }
}

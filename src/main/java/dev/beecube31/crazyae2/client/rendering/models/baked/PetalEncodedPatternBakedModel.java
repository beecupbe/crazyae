...
public class PetalEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        PetalEncodedPattern iep = (PetalEncodedPattern) stack.getItem();
    ...
    public PetalEncodedPatternBakedModel(IBakedModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms) {
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(PetalEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            ...
            return PetalEncodedPatternBakedModel.this.baseModel.getOverrides().handleItemState(originalModel, stack, world, entity);
        }
    }
}

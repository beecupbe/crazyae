...
public class ElventradeEncodedPatternModel implements IModel {

    private static final ResourceLocation BASE_MODEL = new ResourceLocation(Tags.MODID, "item/elventrade_encoded_pattern");
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new ElventradeEncodedPatternBakedModel(baseModel, transforms);
    }

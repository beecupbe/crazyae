...
import dev.beecube31.crazyae2.common.items.patterns.TeraplateEncodedPattern;
...
public class TeraplateEncodedPatternBakedModel implements IBakedModel {
    ...
    public static final IItemColor PATTERN_ITEM_COLOR_HANDLER = (stack, tintIndex) -> {
        TeraplateEncodedPattern iep = (TeraplateEncodedPattern) stack.getItem();
    ...
    public TeraplateEncodedPatternBakedModel(IBakedModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, TRSRTransformation> transforms) {
    ...
    private class CustomOverrideList extends ItemOverrideList {
        ...
        CustomOverrideList() {
            super(TeraplateEncodedPatternBakedModel.this.baseModel.getOverrides().getOverrides());
        }
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            ...
            return TeraplateEncodedPatternBakedModel.this.baseModel.getOverrides().handleItemState(originalModel, stack, world, entity);
        }
    }
}
